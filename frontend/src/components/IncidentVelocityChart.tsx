...
export function IncidentVelocityChart({ data }: { data: ChartPoint[] }) {
  return (
    <div className="w-full h-[300px] min-w-0" style={{ minHeight: CHART_HEIGHT, minWidth: 100 }}>
      <ResponsiveContainer width="100%" height={CHART_HEIGHT} minWidth={100} minHeight={CHART_HEIGHT}>
        <AreaChart data={data}>
